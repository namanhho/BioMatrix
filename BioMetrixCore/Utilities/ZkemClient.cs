...
{
    public class ZkemClient : AxFP_CLOCKLib.AxFP_CLOCK
    {
        ...
        {
            return objCZKEM.SetBellSchDataEx(dwMachineNumber, weekDay, Index, Enable, Hour, min, voice, way, InerBellDelay, ExtBellDelay);
        }
        ...
        {
            return objCZKEM.GetMaxBellIDInBellSchData(dwMachineNumber, out MaxBellID);
        }
        ...
        {
            return objCZKEM.GetEachBellInfo(dwMachineNumber, out weekDay, out Index, out Enable, out Hour, out min, out voice, out way, out InerBellDelay, out ExtBellDelay);
        }
        ...
        {
            return objCZKEM.SetUserValidDate(dwMachineNumber, UserID, Expires, ValidCount, StartDate, EndDate);
        }
        ...
        {
            return objCZKEM.GetAllSFIDName(dwMachineNumber, out ShortkeyIDName, BufferSize1, out FunctionIDName, BufferSize2);
        }
        ...
        {
            return objCZKEM.SetShortkey(dwMachineNumber, ShortKeyID, ShortKeyName, FunctionName, ShortKeyFun, StateCode, StateName, Description, StateAutoChange, StateAutoChangeTime);
        }
        ...
        {
            return objCZKEM.GetShortkey(dwMachineNumber, ShortKeyID, ref ShortKeyName, ref FunctionName, ref ShortKeyFun, ref StateCode, ref StateName, ref Description, ref AutoChange, ref AutoChangeTime);
        }

        public bool GetAllAppFun(int dwMachineNumber, out string AppName, out string FunofAppName)
        {
            return objCZKEM.GetAllAppFun(dwMachineNumber, out AppName, out FunofAppName);
        }
        ...
        {
            return objCZKEM.GetGeneralLogDataStr(dwMachineNumber, ref dwEnrollNumber, ref dwVerifyMode, ref dwInOutMode, ref TimeStr);
        }
        ...
        {
            return objCZKEM.GetSuperLogData(dwMachineNumber, ref dwTMachineNumber, ref dwSEnrollNumber, ref Params4, ref Params1, ref Params2, ref dwManipulation, ref Params3, ref dwYear, ref dwMonth, ref dwDay, ref dwHour, ref dwMinute);
        }
        ...
        {
            return objCZKEM.GetAllSLogData(dwMachineNumber, ref dwTMachineNumber, ref dwSEnrollNumber, ref Params4, ref Params1, ref Params2, ref dwManipulation, ref Params3, ref dwYear, ref dwMonth, ref dwDay, ref dwHour, ref dwMinute);
        }
        ...
        {
            return objCZKEM.SSR_OutPutHTMLRep(dwMachineNumber, dwEnrollNumber, AttFile, UserFile, DeptFile, TimeClassFile, AttruleFile, BYear, BMonth, BDay, BHour, BMinute, BSecond, EYear, EMonth, EDay, EHour, EMinute, ESecond, TempPath, OutFileName, HTMLFlag, resv1, resv2);
        }
        ...
        {
            return objCZKEM.GetSuperLogData2(dwMachineNumber, ref dwTMachineNumber, ref dwSEnrollNumber, ref Params4, ref Params1, ref Params2, ref dwManipulation, ref Params3, ref dwYear, ref dwMonth, ref dwDay, ref dwHour, ref dwMinute, ref dwSecs);
        }
        ...
        {
            return objCZKEM.GetSuperLogDataEx(dwMachineNumber, ref EnrollNumber, ref Params4, ref Params1, ref Params2, ref dwManipulation, ref Params3, ref dwYear, ref dwMonth, ref dwDay, ref dwHour, ref dwMinute, ref dwSecond);
        }
        ...
        {
            return objCZKEM.ReadAllSLogData(dwMachineNumber);
        }
        ...
        {
            return objCZKEM.ReadAllBellSchData(dwMachineNumber);
        }
